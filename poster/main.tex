...
{\bf Image pre-processing.} TODO Audrey! Describe your magic. And include a picture below showing pre- and post-processing. TODO Roger and Jenny should also talk about how to deal with rotations and skewing.

{\bf Data generation.} Base images for the training data are created as black and white bitmaps from the numbers 0-9 in College font. This is accomplished with the Python Image Library (PIL).
...
We used the k-nearest neighbors algorithm as a baseline.

\end{block}

\begin{block}{Random Forest}

We also used random forests.
...
TODO This is how an SVM works. We used the following features.

\begin{itemize}
\item Histogram of Oriented Gradients (HoG). We use the Sobel operator to compute the gradient. We divide the image into four bins and compute the histogram.
\end{itemize}
